...
int main()
{
    char change_fname[50], change_lname[50], change_password1[50], change_password2[50], org_pass_check[50]; 
    ...
    case '3' : 
        ...
        scanf("%c", org_pass_check);
            if (strcmp(org_pass_check, password) == 0)
            {
                printf("Correct Original Password");
            }else 
                printf("Incorrect Original Password");
                printf("Re-enter original Password");
                scanf("%c", org_pass_check);
